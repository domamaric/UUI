...
if __name__ == "__main__":
    ...
    parser.add_argument('--nn', help='the neural network architecture', choices=['5s', '20s', '5s5s'])
    parser.add_argument('--popsize', help='the population size for gen. algo.', type=int)
    parser.add_argument('--elitism', help='the elitism od the gen. algo.', type=int)
    parser.add_argument('--p', help=('the mutation probability of each chromosome element'), type=float)
    parser.add_argument('--K', help=('the standard deviation of the mutation Gaussian noise'), type=float)
    parser.add_argument('--iter', help='the number of gen. algo. iterations', type=int)
